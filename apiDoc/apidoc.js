 ...
 *   curl -d "name=lihongen&pass=ffff&geohash=ww0y51rcstxn" http://http://ubuntu-redred.myalauda.cn/users/register
...
/**
 * @api {post} /users/token 获取token值
 * @apiName GetToken
 * @apiPermission none
 * @apiGroup User
 * @apiDescription 获取校验token，用来接口请求，有效期五天
 * @apiExample {curl} 接口示例：
 *   curl -d "uid=7&pwd=ffff" http://http://ubuntu-redred.myalauda.cn/users/token
